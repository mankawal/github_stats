...
export default function MainPanel() {
  ...
  return (
    <div className="w-full h-screen p-6">
      ...
      />
      <div className="w-full h-full grid grid-cols-5 grid-rows-12 gap-2">
        <div className="row-span-8 col-span-1 row-start-1 col-start-1 bg-teal-50 rounded overflow-auto">
          <RepoRanked width={300} height={100}
            data={dataForksRepos} setHoveredRepo={setFilterRepo} />
        </div>
        <div className="row-span-4 col-span-4 row-start-1 col-start-2 bg-green-50 rounded overflow-auto">
          <TopicRepoHeatMap width={500} height={300}
            data={dataForksTopicsRepos}
            filterRepo={filterRepo} filterTopic={filterTopic} />
        </div>
        <div className="row-span-4 col-span-3 row-start-5 col-start-2 bg-white-50 rounded overflow-auto">
          <TopicRanked width={600} height={600}
            data={dataForksTopics} setHoveredTopic={handleTopicSelection} />
        </div>

        <div className="row-span-8 col-span-1 row-start-5 col-start-5 bg-blue-50 rounded overflow-auto">
          <LangRanked width={300} height={600}
            data={dataForksLangs} setHoveredLang={setFilterLang} />
        </div>
        <div className="row-span-4 col-span-4 row-start-9 col-start-1 bg-sky-50 rounded overflow-auto">
